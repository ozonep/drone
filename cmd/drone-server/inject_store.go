...
import (
	...
	"github.com/ozonep/drone/metric"
	"github.com/ozonep/drone/store/batch"
	"github.com/ozonep/drone/store/batch2"
	"github.com/ozonep/drone/store/build"
	"github.com/ozonep/drone/store/cron"
	"github.com/ozonep/drone/store/logs"
	"github.com/ozonep/drone/store/perm"
	"github.com/ozonep/drone/store/repos"
	"github.com/ozonep/drone/store/secret"
	"github.com/ozonep/drone/store/secret/global"
	"github.com/ozonep/drone/store/shared/db"
	"github.com/ozonep/drone/store/shared/encrypt"
	"github.com/ozonep/drone/store/stage"
	"github.com/ozonep/drone/store/step"
