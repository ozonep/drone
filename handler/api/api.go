...
import (
	...
	"github.com/ozonep/drone/handler/api/acl"
	"github.com/ozonep/drone/handler/api/auth"
	"github.com/ozonep/drone/handler/api/badge"
	globalbuilds "github.com/ozonep/drone/handler/api/builds"
	"github.com/ozonep/drone/handler/api/ccmenu"
	"github.com/ozonep/drone/handler/api/events"
	"github.com/ozonep/drone/handler/api/queue"
	"github.com/ozonep/drone/handler/api/repos"
	"github.com/ozonep/drone/handler/api/repos/builds"
	"github.com/ozonep/drone/handler/api/repos/builds/branches"
	"github.com/ozonep/drone/handler/api/repos/builds/deploys"
	"github.com/ozonep/drone/handler/api/repos/builds/logs"
	"github.com/ozonep/drone/handler/api/repos/builds/pulls"
	"github.com/ozonep/drone/handler/api/repos/builds/stages"
	"github.com/ozonep/drone/handler/api/repos/collabs"
	"github.com/ozonep/drone/handler/api/repos/crons"
	"github.com/ozonep/drone/handler/api/repos/encrypt"
	"github.com/ozonep/drone/handler/api/repos/secrets"
	"github.com/ozonep/drone/handler/api/repos/sign"
	globalsecrets "github.com/ozonep/drone/handler/api/secrets"
	"github.com/ozonep/drone/handler/api/system"
	"github.com/ozonep/drone/handler/api/user"
	"github.com/ozonep/drone/handler/api/user/remote"
	"github.com/ozonep/drone/handler/api/users"
